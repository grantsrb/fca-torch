...
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, AutoModelForImageTextToText
...
def main(script_args, training_args, model_args):
    #print("script args")
    #print(script_args)
    #for d in sorted(dir(script_args)):
    #    print(d, getattr(script_args, d))
    #print
    ################
